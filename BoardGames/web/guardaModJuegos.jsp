...
<html>
    ...
    <body>
        <%
            ...
            String actualizacion = "UPDATE Juegos SET "
                    + "genero='" + request.getParameter("genero")
                    + "', nombre='" + request.getParameter("nombre")
                    + "', editorial='" + request.getParameter("editorial")
                    + "', precio=" + Double.valueOf(request.getParameter("precio"))
                    + ", Autores_id=" + Integer.valueOf(request.getParameter("Autores_id"))
                    + " WHERE Juegos_id=" + Integer.valueOf(request.getParameter("Juegos_id"));
